...
#ifndef TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OVIS_CONTROLLER_INTERFACE_HPP_
#define TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OVIS_CONTROLLER_INTERFACE_HPP_
...
using ControllerStateMsg = ovis_controller::OvisController::ControllerStateMsg;
using ControllerReferenceMsg = ovis_controller::OvisController::ControllerReferenceMsg;
using ControllerModeSrvType = ovis_controller::OvisController::ControllerModeSrvType;
...
class TestableOvisController : public ovis_controller::OvisController
{
  FRIEND_TEST(OvisControllerTest, all_parameters_set_configure_success);
  FRIEND_TEST(OvisControllerTest, activate_success);
  FRIEND_TEST(OvisControllerTest, reactivate_success);
  FRIEND_TEST(OvisControllerTest, test_setting_slow_mode_service);
  FRIEND_TEST(OvisControllerTest, test_update_logic_fast);
  FRIEND_TEST(OvisControllerTest, test_update_logic_slow);

public:
  controller_interface::CallbackReturn on_configure(
    const rclcpp_lifecycle::State & previous_state) override
  {
    auto ret = ovis_controller::OvisController::on_configure(previous_state);
...
class OvisControllerFixture : public ::testing::Test
{
public:
  ...
  void SetUp()
  {
    ...
    command_publisher_ = command_publisher_node_->create_publisher<ControllerReferenceMsg>(
      "/test_ovis_controller_interface/commands", rclcpp::SystemDefaultsQoS());
    ...
    slow_control_service_client_ = service_caller_node_->create_client<ControllerModeSrvType>(
      "/test_ovis_controller_interface/set_slow_control_mode");
  }
...
protected:
  void SetUpController(const std::string controller_name = "test_ovis_controller_interface")
  {
  ...
  void subscribe_and_get_messages(ControllerStateMsg & msg)
  {
    ...
    auto subscription = test_subscription_node.create_subscription<ControllerStateMsg>(
      "/test_ovis_controller_interface/state", 10, subs_callback);
...
protected:
  ...
  std::unique_ptr<TestableOvisController> controller_;
...
#endif  // TEMPLATES__ROS2_CONTROL__CONTROLLER__TEST_OVIS_CONTROLLER_INTERFACE_HPP_
