...
#include "test_ovis_controller_interface.hpp"
...
using ovis_controller::CMD_MY_ITFS;
using ovis_controller::control_mode_type;
using ovis_controller::STATE_MY_ITFS;

class OvisControllerTest : public OvisControllerFixture<TestableOvisController>
{
};

TEST_F(OvisControllerTest, all_parameters_set_configure_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, check_exported_intefaces)
{
  SetUpController();
...
TEST_F(OvisControllerTest, activate_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, update_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, deactivate_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, reactivate_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, test_setting_slow_mode_service)
{
  SetUpController();
...
TEST_F(OvisControllerTest, test_update_logic_fast)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OvisControllerTest, test_update_logic_slow)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
...
TEST_F(OvisControllerTest, publish_status_success)
{
  SetUpController();
...
TEST_F(OvisControllerTest, receive_message_and_publish_updated_status)
{
  SetUpController();
  rclcpp::executors::MultiThreadedExecutor executor;
  executor.add_node(controller_->get_node()->get_node_base_interface());
